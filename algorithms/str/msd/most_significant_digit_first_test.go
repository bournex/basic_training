...
func TestMostSignificantDigitFirst(t *testing.T) {
	corpus := []struct {
		...
		},
		{
			...
			[]string{
				"GitHub", "GitHub", "Information", "Personal", "User", "We", "We", "also", "also", "amount",
				"and", "and", "and", "automatically", "choose", "collect", "collect", "collect", "collects", "consent",
				"cookies", "device", "directly", "for", "from", "from", "from", "from", "information", "information",
				"information", "information", "may", "minimum", "more", "necessary", "necessary", "of", "only", "parties",
				"payment", "personal", "profile", "provide", "registration", "similar", "subject", "technologies", "the", "third",
				"to", "to", "transactions", "unless", "usage", "user", "where", "you", "you", "you",
				"you", "your", "your", "your",
			},
		},
	}
